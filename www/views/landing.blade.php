            ...
            <div class="container">
                ...
                <div class="story-grid">
                    <div class="story-content">
                        ...
                        <div style="background: #fff1f2; border-left: 4px solid #ef4444; padding: 1rem; margin-bottom: 1.5rem; border-radius: 0 0.5rem 0.5rem 0;">
                            <strong>Головний біль №1:</strong><br>
                            Ви не розумієте, хто, коли і на якому авто працював. Графіки в голові, в чатах або на папірцях. Коли приходить штраф — ви не знаєте, з кого його списати.
                        </div>

                        <p>Інформація розпорошена. Документи у різних людей. Немає єдиного центру правди.</p>
