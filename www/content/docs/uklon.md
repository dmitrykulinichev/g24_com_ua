...
*   **Link Fleet:** Функціонал для зв'язування автомобілів у локальній базі з автомобілями в кабінеті Uklon. Дозволяє уникнути дублювання даних.
...
*   Моніторинг статусу водія в агрегаторі (Активний/Заблокований).

{{screenshot file="uklon_drivers_sync.png" title="Driver Synchronization"}}

## Аналітика (Uklon Reports)
Спеціалізовані звіти на основі даних агрегатора.
*   **Dashboard:** Загальні KPI (Дохід, Поїздки, Пробіг, Середній чек), графік динаміки доходів.
*   **Drivers:** Рейтинг ефективності водіїв (Дохід, Кількість поїздок, грн/км).
*   **Vehicles:** Рейтинг ефективності автомобілів.
