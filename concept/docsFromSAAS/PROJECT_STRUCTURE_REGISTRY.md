...
### Сторінка: Нормативи ефективності (Performance Normatives)
**Файл:** `PerformanceNormatives/index.jsx`
**Модальні вікна:**
1.  **PerformanceNormativeModal** — Створення/Редагування профілю нормативу (KPI).
...
*   *Сторінка з вкладками:*
    *   **OperationalReportTab:** Оперативна статистика (День/Тиждень/Місяць) з прогнозами.
        *   *Функціонал:* Таблиця з деталізацією по днях, експорт в Excel.
